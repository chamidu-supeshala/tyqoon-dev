...
; (function (window, $, undefined) {
  ...
  function profilePicture(cssSelector, imageFilePath, options) {
      ...
      function removeImage() {
          self.canvasContext.clearRect(0, 0, self.model.cropWidth * pxRatio, self.model.cropHeight * pxRatio);
          self.canvasContext.save();
          self.photoArea.addClass('photo--empty');
          self.imageHelperCanvasContext.clearRect(0, 0, self.imageHelperCanvas.width * pxRatio,self.imageHelperCanvas.height * pxRatio);
      ...
      function render() {
          ...
          self.canvasContext.drawImage(self.model.imageSrc, self.model.x * pxRatio, self.model.y * pxRatio, self.model.width * pxRatio, self.model.height * pxRatio);
      ...
      function updateHelper() {
          ...
          self.imageHelperCanvasContext.rect(0,0,self.imageHelperCanvas.width * pxRatio, self.imageHelperCanvas.height * pxRatio);
          self.imageHelperCanvasContext.fillStyle = self.options.imageHelperColor;
          self.imageHelperCanvasContext.fill('evenodd');
          /**
           * Draw the image
           */
          self.imageHelperCanvasContext.drawImage(self.model.imageSrc, x * pxRatio, y * pxRatio, self.model.width * pxRatio, self.model.height * pxRatio);
